...
df = pd.read_csv("../data/zillow_housing_data.csv", na_values=[',,,'])
...
df.to_csv("../data/zillow_housing_cleaned.csv", index=False)

print("Missing values filled using forward-fill and saved to '../data/zillow_housing_cleaned.csv'.")
